...
@interface HotTracksCollectionViewCell ()
...
@implementation HotTracksCollectionViewCell
...
- (void)setModel:(id<HotTracksCollectionViewCellObjectProtocol>)model {
